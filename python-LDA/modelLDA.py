...
# print(lsi.print_topics(num_topics=5, num_words=5))   # 打印5个主题并且打印与主题有关的5个关键词，关键词前面的系数为权重而不是概率值
...
lda = models.LdaModel(corpus_tfidf, num_topics=5, id2word=dictionary, alpha='auto', eta='auto', minimum_probability=0.001)
